...
app.get('/', (req, res) => {
    ...
    const sql = 'SELECT * FROM products'; // Replace with your actual SQL query

    connection.query(sql, (error, results) => {
        if (error) {

            console.error('Error executing query:', error);
            return res.send('Error Retriving products');
        }
...
app.get('/addProduct', upload.single('image'), (req, res) => {
